                ...
                .whenComplete(Schedulers.androidUIThread(), (result, exception) -> {
                    if (exception != null) {
                        ...
                        if (result == null || result.getSkin() == null && result.getCape() == null) {
                            renderer.setTexture(getDefaultSkin(TextureModel.detectUUID(account.getUUID())), null);
                            return;
                        }
                        renderer.setTexture(
                            result.getSkin() != null
                                ? result.getSkin().getImage()
                                : getDefaultSkin(TextureModel.detectUUID(account.getUUID())),
