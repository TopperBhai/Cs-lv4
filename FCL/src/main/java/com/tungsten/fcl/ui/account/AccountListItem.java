...
public class AccountListItem {
    ...
    // ✅ FIX: image → ObjectProperty<Bitmap> (avatarBinding returns ObservableValue<Bitmap>)
    private final ObjectProperty<Bitmap> image = new SimpleObjectProperty<>();

    // ✅ FIX: texture → ObjectProperty<Bitmap> (textureBinding returns ObservableValue<Bitmap>)
    ...
    public AccountListItem(Context context, Account account) {
        ...
        // ✅ FIX: avatarBinding returns ObservableValue<Bitmap> - directly bind
        image.bind(TexturesLoader.avatarBinding(account, ConvertUtils.dip2px(context, 30f)));

        // ✅ FIX: textureBinding returns ObservableValue<Bitmap> - directly bind
    ...
    // ✅ FIX: return type Bitmap (was Drawable)
    ...
    public ObjectProperty<Bitmap> imageProperty() {
        return image;
    }

    // ✅ FIX: return type Bitmap (was Bitmap[])
